...
from milestone_03_scan_left_motion_authority import arm_scan_left

permit = arm_scan_left()

print()
print("RoArm SCAN LEFT motion ARMED")
print("Authority: LOCAL OPERATOR / ONE USE")
print("Expires: 120 seconds")
print("Authority SHA-256:", permit["sha256"])
print()
print("The next authorized Scan Left call may execute physical motion.")

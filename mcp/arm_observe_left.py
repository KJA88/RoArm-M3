...
from milestone_03_observe_left_motion_authority import arm_observe_left

permit = arm_observe_left()

print()
print("RoArm OBSERVE LEFT motion ARMED")
print("Authority: LOCAL OPERATOR / ONE USE")
print("Expires: 120 seconds")
print("Authority SHA-256:", permit["sha256"])
print()
print("The next authorized Observe Left call may execute physical motion.")

...
AUTH_FILE = RUNTIME_DIR / "scan_right_authority.json"
...
# Physically verified OBSERVE_RIGHT base target.
...
def execute_scan_right():
    ...
    try:
        ...
        return {
            "ok": False,
            "authorized": False,
            "error": "Local Scan Right authorization is not armed",
            "hardware_action": "NONE",
        }
    ...
    if (
        permit.get("scope") != "ONE_SCAN_RIGHT"
        or age < 0
        ...
        return {
            "ok": False,
            "authorized": False,
            "error": "Scan Right authorization invalid or expired",
            "hardware_action": "NONE",
        }
    ...
    if permit.get("sha256") != _sha256(THIS_FILE):
        ...
        return {
            "ok": False,
            "authorized": False,
            "error": "Scan Right authority code changed after arming",
            "hardware_action": "NONE",
        }
    ...
    try:
        ...
        try:
            ...
            _audit("SCAN_STAGE", routine="scan_right", stage="READY")
            _send(ser, READY)
            time.sleep(3.0)
        ...
        return {
            ...
            "routine": "SCAN_RIGHT",
            "start_pose": "READY",
            "target": "OBSERVE_RIGHT",
            "scan_speed": SCAN_SPEED,
            "scan_acceleration": SCAN_ACCEL,
            "final_state": final_state,
            "hardware_action": "SCAN_RIGHT_EXECUTED",
        }
